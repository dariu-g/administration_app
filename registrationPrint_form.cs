...
{
    public partial class registrationPrint_form : Form
    {
        registration_class _param;
        List<registration_class> _list = new List<registration_class>();
        public registrationPrint_form(registration_class param, List<registration_class> list)
        {
            InitializeComponent();
            _param = param;
            _list = list;
        ...
        private void registrationPrint_form_Load(object sender, EventArgs e)
        {
            registrationclassBindingSource.DataSource = _list;
            Microsoft.Reporting.WinForms.ReportParameter[] parameters = new Microsoft.Reporting.WinForms.ReportParameter[]
            {
                ...
                new Microsoft.Reporting.WinForms.ReportParameter("pcod_telefon", _param.cod_telefon.ToString()),
                ...
                new Microsoft.Reporting.WinForms.ReportParameter("ppret_estimativ", _param.pret_estimativ.ToString()),
                new Microsoft.Reporting.WinForms.ReportParameter("ppret_avans", _param.pret_avans.ToString()),
                ...
                new Microsoft.Reporting.WinForms.ReportParameter("ptermen_rezolvare", _param.termen_rezolvare.ToString())
            };
